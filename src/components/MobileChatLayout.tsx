...
import FriendRequestSidebarOptions from "./ui/sidebar/FriendRequestSidebarOptions";
import SidebarChatList from "./ui/sidebar/SideBarChatList";
  ...
  return (
    <div className="fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4">
      <div className="w-full flex justify-between items-center">
        ...
        >
          <BiSolidDashboard className="h-5 w-auto" />
        </Link>
        <Button
